...
@section('title', 'Daftarkan Pengguna | Sistem Absensi Kelas Al-Barokah')
  ...
  <form method="POST" action="{{ route('admin.register.user') }}" id="registerUserForm">
      ...
      <div class="row">
          <div class="col-md-6 mb-3">
              ...
              <input type="text" name="name" class="form-control border border-secondary-subtle" placeholder="Masukkan nama lengkap" required>
          </div>

          <div class="col-md-6 mb-3">
              <label class="form-label fw-semibold">Email</label>
              <input type="email" name="email" class="form-control border border-secondary-subtle" placeholder="contoh@email.com" required>
          </div>
      </div>
      ...
      <div class="row">
          <div class="col-md-4 mb-3">
              ...
              <input type="password" name="password" class="form-control border border-secondary-subtle" placeholder="Masukkan kata sandi" required>
          </div>

          <div class="col-md-4 mb-3">
              <label class="form-label fw-semibold">Konfirmasi Kata Sandi</label>
              <input type="password" name="password_confirmation" class="form-control border border-secondary-subtle" placeholder="Masukkan ulang kata sandi" required>
          </div>
      ...
      <div class="d-flex justify-content-end mt-3">
          <button type="submit" id="submitBtn" class="btn btn-primary d-flex align-items-center gap-2">
              ...
              <span id="submitText"><i class="bi bi-save2 me-1"></i>Daftarkan Pengguna</span>
          </button>
      </div>
  </form>
</div>
