    ...
    <div class="sticky-top bg-white shadow-sm py-2 mb-0">
        <div class="d-flex flex-wrap justify-content-between align-items-center">
            ...
            <div class="d-flex gap-2 align-items-center">
                ...
                <a href="{{ route('admin.assignments.create') }}" class="btn btn-sm btn-primary">
                ...
                @forelse($assignments as $assignment)
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-3 py-1 text-center">
                            ...
                            <!-- Delete Form + Button -->
                            <form id="deleteAssignmentForm{{ $assignment->id }}" action="{{ route('admin.assignments.destroy', $assignment->id) }}" method="POST" class="d-none">
                                @csrf
                                @method('DELETE')
                            </form>
                            <button type="button"
