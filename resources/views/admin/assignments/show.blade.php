...
<div class="container-fluid px-2">
        ...
        <div class="card-body">
            ...
            @forelse($assignment->questions as $question)
                <div class="border rounded-3 p-3 mb-2">
                    <div class="d-flex justify-content-between align-items-start gap-2">
                        ...
                        <div class="d-flex gap-1 flex-shrink-0">
                            ...
                            <form id="deleteQuestionForm{{ $question->id }}" action="{{ route('admin.assignments.questions.destroy', [$assignment->id, $question->id]) }}" method="POST" class="d-none">
                                @csrf
                                @method('DELETE')
                            </form>
                ...
                <div class="modal fade" id="editQuestionModal{{ $question->id }}" tabindex="-1" aria-hidden="true">
                  <div class="modal-dialog modal-lg modal-dialog-centered">
                      <div class="modal-content border border-1 border-primary rounded-4 shadow">
                      <form action="{{ route('admin.assignments.questions.update', [$assignment->id, $question->id]) }}" method="POST" onsubmit="return prepareQuestionSubmit(this)">
                          @csrf
                          @method('PUT')
                          <div class="modal-header py-2 px-3">
                              <h5 class="modal-title fw-bold d-flex align-items-center gap-2">
    ...
    <div class="modal fade" id="addQuestionModal" tabindex="-1" aria-hidden="true">
      <div class="modal-dialog modal-lg modal-dialog-centered">
          <div class="modal-content border border-1 border-primary rounded-4 shadow">
          <form action="{{ route('admin.assignments.questions.store', $assignment->id) }}" method="POST" onsubmit="return prepareQuestionSubmit(this)">
              @csrf
              <div class="modal-header py-2 px-3">
                  <h5 class="modal-title fw-bold d-flex align-items-center gap-2">
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            <!-- Assign Form -->
            <form action="{{ route('admin.assignments.assign', $assignment->id) }}" method="POST" class="border rounded-3 p-3 mb-3 bg-light">
                @csrf
                <div class="mb-2">
                    <div class="form-check form-check-inline">
